...
export class MTLLoader implements THREE.MTLLoader {
...
export class MaterialCreator implements THREE.MaterialCreator {
	...
	loadTexture(url:string, mapping:any, onLoad:any, onProgress:any, onError:any ) {
		...
		var texture;
		var loader:any = THREE.Loader.Handlers.get( url );
